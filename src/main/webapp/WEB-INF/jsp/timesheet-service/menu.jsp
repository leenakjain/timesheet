...
<%--@elvariable id="busiestTask" type="org.lnk.timesheet.domain.Task"--%>
<%--@elvariable id="managers" type="java.util.List<org.lnk.timesheet.domain.Manager>"--%>
<%--@elvariable id="employees" type="java.util.List<org.lnk.timesheet.domain.Employee>"--%>
